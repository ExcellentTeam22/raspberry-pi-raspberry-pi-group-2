...
# mp_pose = mp.solutions.pose  # my addition
...
actions = np.array(['push', 'moving', 'air'])  # 2
# actions = np.array(['hit', 'nothing', 'air'])  # 1
# actions = np.array(['slap', 'fist'])  # 0
#
...
new_model = tf.keras.models.load_model('action2.h5')
